...
* Added /v2/services/events to return processed docker logs [Miguel Casqueira]
* Add `docker` log level [Thomas Manning]
* Add LogBuffer for events route [Thomas Manning]
