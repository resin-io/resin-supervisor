...
export async function loadTargetFromFile(
	...
	try {
		...
		for (const uuid of uuids) {
			...
			// Do not let the supervisor manage images for
			// non supervised apps, these images are managed by the
			// OS. TODO: modify this when we add supervisor support for
			// hostapp extensions and 'supervisor' apps
			if (app.type !== 'supervised') {
				continue;
			}
